...
import '../widgets/upload_image_edit.dart';
...
class _EditProductPageState extends State<EditProductPage> {
  int _currentStep = 0;
  late EditProductController _controller;
  ...
  void initState() {
    super.initState();
    _controller = EditProductController();
    _controller.initializeWithProduct(widget.product);
  }
  ...
  Future<void> submitForm() async {
    final success = await _controller.updateProduct(context);
    if (success && mounted) {
      setState(() {
        _isSubmitted = true;
      });
  ...
  String? _validateCurrentStep() {
    switch (_currentStep) {
      case 0:
        ...
        break;
      case 1:
        if (_controller.images.isEmpty && _controller.existingImageUrls.isEmpty) {
  ...
  Widget _buildImageStep() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [ImageUploadSectionGeneric(controller: _controller)],
    ).animate().fadeIn(duration: 400.ms).slideY(begin: 0.1, end: 0);
  }
      ...
      builder: (context, controller, _) {
        ...
        return Column(
          ...
          children: [
            ...
            SearchableDropdown(
              label: 'State',
              hint: controller.isLocationDataReady ? 'Select state' : 'Loading states...',
              ...
              child: controller.showSubDistrict
                ...
                children: [
                  ...
                  SearchableDropdown(
                    ...
                    onChanged: (value) => controller.selectSubDistrict(value),
            ...
            SearchableDropdown(
              label: 'Village',
              hint: controller.allowManualVillageEntry ? 'Type village name' : 'Select village',
            ...
            GestureDetector(
              onTap: () {
                _showIOSPicker(
                  ...
                  items: EditProductController.conditions,
                      ...
                      child: ElevatedButton(
                        ...
                        child: controller.isLoading || controller.isUploading
                          ...
                          children: [
                            ...
                            SizedBox(width: 12),
                            Text(
                              controller.isUploading ? 'Uploading...' : 'Updating...',
                              style: AppTextStyles.button.copyWith(
                                color: AppColors.white,
                                fontSize: 16,
                              ),
